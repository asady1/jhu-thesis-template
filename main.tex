...
\newcommand{\cPqb}{\rm b}
\newcommand{\Hbb}{\mathrm{H}\rightarrow\cPqb\overline{\cPqb}}
...
\newcommand{\PWp}{\rm W^{+}}
\newcommand{\PWm}{\rm W^{-}}
\newcommand{\PZz}{\rm Z^{0}}
\newcommand{\TeV}{TeV}
\newcommand{\Mpl}{M_{Pl}}
\newcommand{\Pp}{p}
\newcommand{\Hbbt}{double \cPqb\,tagger\xspace}
\newcommand{\Sjbt}{subjet \PQb\,tagger\xspace}
\newcommand{\GRS}{ \mathrm{G}_\mathrm{RS}} 
\newcommand{\mjjs}{ M_{\rm jjj}^{\rm red}} 
\newcommand{\Mjjs}{ M_{\rm jjj}^{\rm red}} 
\newcommand{\mjj}{ M_{\rm jjj}} 
\newcommand{\Mjj}{ M_{\rm jjj}} 
\newcommand{\mH}{ M_{\rm \PH}} 
\newcommand{\mx}{ M_{\rm X}} 
\newcommand{\mux}{ \mu_{\rm X}^{\rm CB}} 
\newcommand{\nsub}{ \tau_{21}} 
\newcommand{\etaj}{ |\eta|} 
\newcommand{\deta}{ |\Delta\eta_{\rm jj}|} 
\newcommand{\mjp}{ M_{\rm jet}^{\rm pruned}} 
\newcommand{\mjsd}{ M_{\rm jet}^{\rm softdrop,puppi}} 
\newcommand{\mj}{ M_{\rm jet}} 
\newcommand{\LambdaR}{\Lambda_{\rm R}}
\newcommand{\HH}{\PH\PH}
\newcommand{\bbbar}{b$\bar{\rm b}$}
\newcommand{\sgx}{\sigma_{\rm X}^{\rm gaus}}
\newcommand{\scbx}{\sigma_{\rm X}^{\rm CB}}
\newcommand{\HbbHbb}{\mathrm{\Hbb\Hbb}}
\newcommand{\XHbbHbb}{\mathrm{X}\rightarrow\PH\PH\rightarrow\bbbar\bbbar}
...
\begin{center}
\vspace*{.25in}
{\bf\LARGE{ Search for New Physics in the Two Higgs to Four b-quark Final State }}\\ % change it accordingly!
\vspace*{.75in}
{\bf by} \\*[18pt]
\vspace*{.2in}
{\bf Alice Cocoros}\\ % change it accordingly!
\vspace*{1in}
...
{\bf June, 2017} \\     % change it accordingly!
\vspace*{.5in}
\begin{small}
{\bf \copyright{ }Alice Cocoros 2017 } \\ % change the year if needed!
...
\include{Intro}
\include{AN_17_182/Introduction}
%\include{BSM}
\include{CMS}
\include{ANintro} 
\include{Ana}
...
\bibliography{Bib}
\include{CVAliceCocoros}

%\begin{vita}
%Alice Cocoros is great
%\end{vita}
