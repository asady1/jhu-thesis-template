...
\item \textbf{Jet Energy Scale}: We have accounted for .2-4\% effect on the yield for signal and up to 1\% for \ttbar. %The JEC uncertainty on the signal shape is about $\pm 1\%$ on the mean and the width, as shown in Fig.~\ref{fig:singalMeanWidthChange_JECUncert}.
